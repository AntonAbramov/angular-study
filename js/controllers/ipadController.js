angular.module('app').controller('ipad1Controller', ['$scope', function ($scope) {
	...
	}]).controller('ipadAir2Controller', ['$scope', function ($scope) {
    $scope.pricesTable = [
      {
        'tableTitle': 'Основное',
        'rows': [
	...
	}]).controller('ipadMini3Controller', ['$scope', function ($scope) {
    $scope.pricesTable = [
      {
        'tableTitle': 'Основное',
        'rows': [
        ...
        'rows': [
          {
            ...
            'repear_time': '60 мин.',
            'cost': '1500/1700 грн.',
            'description': 'На вашем iPad mini 3 разбилось стекло? Замена стекла на iPad mini в нашем сервисе занимает около часа и ваш планшет опять будет как новый.'
          },
          {
            'title': 'Замена корпуса',
            'repear_time': '60 мин.',
